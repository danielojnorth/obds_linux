...
fastqc  --nogroup --threads 2 --extract\
      -o /project/grte3920/1_linux/2_rnaseq/3_analysis/1_fastqc/cluster \
            /project/grte3920/1_linux/2_rnaseq/1_fastq/cd4_rep1_read1.fastq.gz \
                   /project/grte3920/1_linux/2_rnaseq/1_fastq/cd4_rep1_read2.fastq.gz 
